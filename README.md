...
This project provides insight into the vaccine rollout and distribution that is occurring worldwide. Despite this project being updated daily it is important to note that the data captured is representing only one narrative and perspective. This project provides a large overview of the distribution of vaccines but on a smaller scope it does not represent the continual struggle and difficulty of rolling out vaccines. The project also can allow us see how politics and economics may play a factor in vaccine rollout. For example when viewing the data in the format of a world map we can see which countries may have no access or an excess of access to vaccines. This insight can lead us to investigate how economic status and politics of certain countries may restrict or allow vaccine distribution. Aside from the economical and political insight that this project can provide, the project most importantly allows us to track the progress of vaccine rollout and can help predict a situation in when vaccination rates have reached a point where herd immunity is established and life can return to “normal”.
